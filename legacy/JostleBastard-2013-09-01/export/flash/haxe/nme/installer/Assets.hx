...
class Assets {
	...
	private static function initialize ():Void {
		...
		if (!initialized) {
			...
			resourceClasses.set ("assets/png/bastard_standing.png", NME_assets_png_bastard_standing_png);
			resourceTypes.set ("assets/png/bastard_standing.png", "image");
			...
			resourceClasses.set ("assets/png/cafe_door.png", NME_assets_png_cafe_door_png);
			resourceTypes.set ("assets/png/cafe_door.png", "image");
			resourceClasses.set ("assets/png/cafe_wall_bottom.png", NME_assets_png_cafe_wall_bottom_png);
			resourceTypes.set ("assets/png/cafe_wall_bottom.png", "image");
			resourceClasses.set ("assets/png/chair.png", NME_assets_png_chair_png);
			resourceTypes.set ("assets/png/chair.png", "image");
			resourceClasses.set ("assets/png/chair_left.png", NME_assets_png_chair_left_png);
			resourceTypes.set ("assets/png/chair_left.png", "image");
			resourceClasses.set ("assets/png/chair_with_person.png", NME_assets_png_chair_with_person_png);
			resourceTypes.set ("assets/png/chair_with_person.png", "image");
			resourceClasses.set ("assets/png/chair_with_person_left.png", NME_assets_png_chair_with_person_left_png);
			resourceTypes.set ("assets/png/chair_with_person_left.png", "image");
			resourceClasses.set ("assets/png/person_fallen.png", NME_assets_png_person_fallen_png);
			resourceTypes.set ("assets/png/person_fallen.png", "image");
			...
			resourceClasses.set ("assets/png/person_seated.png", NME_assets_png_person_seated_png);
			resourceTypes.set ("assets/png/person_seated.png", "image");
			resourceClasses.set ("assets/png/person_standing.png", NME_assets_png_person_standing_png);
			resourceTypes.set ("assets/png/person_standing.png", "image");
			resourceClasses.set ("assets/png/table.png", NME_assets_png_table_png);
			resourceTypes.set ("assets/png/table.png", "image");
			resourceClasses.set ("assets/png/wall_side.png", NME_assets_png_wall_side_png);
			resourceTypes.set ("assets/png/wall_side.png", "image");
			resourceClasses.set ("assets/png/wall_top.png", NME_assets_png_wall_top_png);
			resourceTypes.set ("assets/png/wall_top.png", "image");
			resourceClasses.set ("assets/ttf/Commodore.ttf", NME_assets_ttf_commodore_ttf);
			resourceTypes.set ("assets/ttf/Commodore.ttf", "font");
			resourceClasses.set ("Commodore", NME_assets_ttf_commodore_ttf1);
			resourceTypes.set ("Commodore", "font");
