...
class ApplicationMain {
	...
	public static function getAsset (inName:String):Dynamic {
		...
		if (inName=="assets/png/person_frames.png")
			 
            return Assets.getBitmapData ("assets/png/person_frames.png");
         
		
		if (inName=="assets/pxa/person_frames.pxa/0.pxi")
			 
            return Assets.getBytes ("assets/pxa/person_frames.pxa/0.pxi");
         
		
		if (inName=="assets/pxa/person_frames.pxa/1.pxi")
			 
            return Assets.getBytes ("assets/pxa/person_frames.pxa/1.pxi");
         
		
		if (inName=="assets/pxa/person_frames.pxa/2.pxi")
			 
            return Assets.getBytes ("assets/pxa/person_frames.pxa/2.pxi");
         
		
		if (inName=="assets/pxa/person_frames.pxa/CelData.plist")
			 
			 return Assets.getText ("assets/pxa/person_frames.pxa/CelData.plist");
...
class NME_assets_png_avatar_4x_png extends nme.display.BitmapData { public function new () { super (0, 0); } }
class NME_assets_png_avatar_8x_png extends nme.display.BitmapData { public function new () { super (0, 0); } }
class NME_assets_png_avatar_small_png extends nme.display.BitmapData { public function new () { super (0, 0); } }
class NME_assets_png_avatar_hit_4x_png extends nme.display.BitmapData { public function new () { super (0, 0); } }
class NME_assets_png_avatar_hit_8x_noalpha_png extends nme.display.BitmapData { public function new () { super (0, 0); } }
class NME_assets_png_avatar_hit_8x_png extends nme.display.BitmapData { public function new () { super (0, 0); } }
class NME_assets_png_cafe_counter_png extends nme.display.BitmapData { public function new () { super (0, 0); } }
class NME_assets_png_cafe_counter_hit_png extends nme.display.BitmapData { public function new () { super (0, 0); } }
class NME_assets_png_cafe_table_and_chairs_png extends nme.display.BitmapData { public function new () { super (0, 0); } }
class NME_assets_png_cafe_table_and_chairs_hit_png extends nme.display.BitmapData { public function new () { super (0, 0); } }
class NME_assets_png_cafe_test_png extends nme.display.BitmapData { public function new () { super (0, 0); } }
class NME_assets_png_cafe_walls_png extends nme.display.BitmapData { public function new () { super (0, 0); } }
class NME_assets_png_cafe_walls_hit_png extends nme.display.BitmapData { public function new () { super (0, 0); } }
class NME_assets_png_enemy_4x_png extends nme.display.BitmapData { public function new () { super (0, 0); } }
class NME_assets_png_enemy_8x_png extends nme.display.BitmapData { public function new () { super (0, 0); } }
class NME_assets_png_person_frames_png extends nme.display.BitmapData { public function new () { super (0, 0); } }
class NME_assets_pxa_person_frames_pxa_0_pxi extends nme.utils.ByteArray { }
class NME_assets_pxa_person_frames_pxa_1_pxi extends nme.utils.ByteArray { }
class NME_assets_pxa_person_frames_pxa_2_pxi extends nme.utils.ByteArray { }
class NME_assets_pxa_person_frames_pxa_celdata_plist extends nme.utils.ByteArray { }
