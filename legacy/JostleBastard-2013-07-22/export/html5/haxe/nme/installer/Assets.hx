...
class Assets {
	...
	private static function initialize ():Void {
		...
		if (!initialized) {
			...
			resourceNames.set ("assets/png/avatar-4x.png", "assets/png/avatar-4x.png");
			resourceTypes.set ("assets/png/avatar-4x.png", "image");
			
			
			resourceNames.set ("assets/png/avatar-8x.png", "assets/png/avatar-8x.png");
			resourceTypes.set ("assets/png/avatar-8x.png", "image");
			
			
			resourceNames.set ("assets/png/avatar-small.png", "assets/png/avatar-small.png");
			resourceTypes.set ("assets/png/avatar-small.png", "image");
			
			
			resourceNames.set ("assets/png/avatar_hit-4x.png", "assets/png/avatar_hit-4x.png");
			resourceTypes.set ("assets/png/avatar_hit-4x.png", "image");
			
			
			resourceNames.set ("assets/png/avatar_hit-8x-noalpha.png", "assets/png/avatar_hit-8x-noalpha.png");
			resourceTypes.set ("assets/png/avatar_hit-8x-noalpha.png", "image");
			
			
			resourceNames.set ("assets/png/avatar_hit-8x.png", "assets/png/avatar_hit-8x.png");
			resourceTypes.set ("assets/png/avatar_hit-8x.png", "image");
			
			
			resourceNames.set ("assets/png/cafe_counter.png", "assets/png/cafe_counter.png");
			resourceTypes.set ("assets/png/cafe_counter.png", "image");
			
			
			resourceNames.set ("assets/png/cafe_counter_hit.png", "assets/png/cafe_counter_hit.png");
			resourceTypes.set ("assets/png/cafe_counter_hit.png", "image");
			
			
			resourceNames.set ("assets/png/cafe_table_and_chairs.png", "assets/png/cafe_table_and_chairs.png");
			resourceTypes.set ("assets/png/cafe_table_and_chairs.png", "image");
			
			
			resourceNames.set ("assets/png/cafe_table_and_chairs_hit.png", "assets/png/cafe_table_and_chairs_hit.png");
			resourceTypes.set ("assets/png/cafe_table_and_chairs_hit.png", "image");
			
			
			resourceNames.set ("assets/png/cafe_test.png", "assets/png/cafe_test.png");
			resourceTypes.set ("assets/png/cafe_test.png", "image");
			
			
			resourceNames.set ("assets/png/cafe_walls.png", "assets/png/cafe_walls.png");
			resourceTypes.set ("assets/png/cafe_walls.png", "image");
			
			
			resourceNames.set ("assets/png/cafe_walls_hit.png", "assets/png/cafe_walls_hit.png");
			resourceTypes.set ("assets/png/cafe_walls_hit.png", "image");
			
			
			resourceNames.set ("assets/png/enemy-4x.png", "assets/png/enemy-4x.png");
			resourceTypes.set ("assets/png/enemy-4x.png", "image");
			
			
			resourceNames.set ("assets/png/enemy-8x.png", "assets/png/enemy-8x.png");
